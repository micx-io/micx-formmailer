...
AppLoader::extend(function () {
    ...
    $app->define("subscriptionId", new DiService(function (array $query) {
        $subscriptionId = $query["subscription_id"] ?? throw new \InvalidArgumentException("Paramter 'subscription_id' is missing");
